...
class ConfigurationWizard(ProductConfiguratorTestCases):
    ...
    def setUpClass(cls):
        ...
        cls.attr_line_fuel = cls.env.ref(
            "product_configurator_fa.product_attribute_line_2_series_fuel"
        )
        ...
        cls.value_218d = cls.env.ref(
            "product_configurator_fa.product_attribute_value_218d"
        )
        cls.value_220d = cls.env.ref(
            "product_configurator_fa.product_attribute_value_220d"
        )
        ...
        cls.config_step_body = cls.env.ref("product_configurator_fa.config_step_body")
        ...
        cls.cfg_tmpl = cls.env.ref("product_configurator_fa.bmw_2_series")
